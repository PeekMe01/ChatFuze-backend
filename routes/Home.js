        ...
        if (countmatch == 5) {
         ...
         if (countmatch == 6) {
          if (attempts == 1) {
            ...
            if ((request.users.rankid == 6 || request.users.rankid == 5) && request.users.rankid == otherReq.users.rankid)
              countmatch++
            else if ((otherReq.users.rankid == 6 || otherReq.users.rankid == 5) && otherReq.users.rankid == request.users.rankid)
              countmatch++
